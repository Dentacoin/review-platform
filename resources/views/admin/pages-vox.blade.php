	...
	<div class="row">
	    ...
	    <div class="col-md-6">
	        ...
	        <div class="panel panel-inverse">
	            ...
	            <div class="panel-body">
	                <form class="form-horizontal" method="post" action="{{ url('cms/pages/vox/export') }}">
	                    {!! csrf_field() !!}
	                    <div class="form-group">
	                        <div class="col-md-12">
	    ...
	    <div class="col-md-6">
	        ...
	        <div class="panel panel-inverse">
	            ...
	            <div class="panel-body">
	                ...
	                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ url('cms/pages/vox/import') }}">
	                    {!! csrf_field() !!}
	                    <div class="form-group">
	                        <div class="col-md-12">
