                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="ui-unlimited-tabs-1">
                    ...
                    <div class="tab-content">
                        @foreach($langs as $code => $lang_info)
                            <div class="lang-tab tab-pane fade{{ $loop->first ? ' active in' : '' }}" data-lang="{{ $code }}" id="nav-tab-{{ $code }}">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::text('question-'.$code, $item->{'question:'.$code}, array(
                                            'maxlength' => 512, 
                                            'class' => 'form-control', 
                                            'id' => 'edit-question'
                                        )) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{ Form::text('slug-'.$code, $item->{'slug:'.$code}, array(
                                            'maxlength' => 128, 
                                            'class' => 'form-control', 
                                            'id' => 'edit-slug'
                                        )) }}
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('category_id', $categories->pluck('name', 'id')->toArray(), $item->category_id, array(
                                    'class' => 'form-control', 
