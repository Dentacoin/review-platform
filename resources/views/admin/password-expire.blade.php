            ...
            <form method="post">
	            ...
	            <div class="login-content">
	                ...
	                <form action="index.html" method="POST" class="margin-bottom-0">
                        <p style="color: white;">Your password has expired, you'll need to update it before you can access the CMS.</p>
	                    ...
	                    <div class="form-group m-b-20">
	                        <input type="password" name="new-password-repeat" class="form-control input-lg" placeholder="Repeat New Password" />
	                    </div>
