	                    ...
	                    <div class="panel panel-default">
	                        <div class="panel-body">
	                            <div class="col-lg-9 col-md-8 col-sm-9 work-wrapper">
	                                <a href="{{ getLangUrl('dentist/'.$workplace->clinic->slug) }}">
	                                    <img src="{{ $workplace->clinic->getImageUrl(true) }}"/>
	                                    <h4> {{ $workplace->clinic->getName() }} </h4>
	                                </a>
	                            </div>
	                            <div class="col-lg-3 col-md-4 col-sm-3 work-buttons">
	                               @if($workplace->approved )
	                                    <a href="{{ getLangUrl('profile/clinics/delete/'.$workplace->clinic->id) }}" class="btn btn-primary rejected-button">
