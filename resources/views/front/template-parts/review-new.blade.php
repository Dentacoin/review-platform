...
@endif
<div class="panel-body review" >
	<a href="javascript:;" class="btn-block new-btn-show-review" style="margin-top: -20px;" data-alt-text="{{ trans('front.page.dentist.review-hide-all') }}">
