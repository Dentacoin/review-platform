		...
		@foreach($reviews as $review)
			<div class="list-review">
				<div class="list-review-left">
					<a href="{{ $u->getLink().'?review_id='.$review->id }}" target="_blank" class="review-avatar" style="background-image: url('{{ $review->user->getImageUrl(true) }}');"></a>
				...
				<div class="list-review-right">
					@if($review->title)
		    			<a href="{{ $u->getLink().'?review_id='.$review->id }}" target="_blank" class="review-title">
		    				“{{ $review->title }}”
		    			</a>
	    			@endif
	    			<div class="ratings">
