	...
	<div class="information flex">
    	...
    	<div class="profile-info col">
    		...
    		<div class="view-profile clearfix">
				<div class="avatar">
					<img data-src="{{ $item->getImageUrl(true) }}" alt="{{ trans('trp.alt-tags.reviews-for', [ 'name' => $item->getNames(), 'location' => ($item->city_name ? $item->city_name.', ' : '').($item->state_name ? $item->state_name.', ' : '').($item->country->name) ]) }}" width="130" height="130">
