		...
		<div class="section-welcome-done" style="display: none;">
			<div class="container">
				...
				<div class="col-md-9 tac">
					...
					<h4>
						You’ve just earned <span class="coins-test">{{ $vox->getRewardTotal() }}</span> DCN! To withdraw your <br/> reward, just go to your <a href="{{ getLangUrl('profile') }}">Wallet.</a> Ready to get more <br/> Dentacoin tokens?
					</h4>
