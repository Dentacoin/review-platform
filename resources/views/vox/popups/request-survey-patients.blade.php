<div class="popup fixed-popup popup-with-background request-survey-popup close-on-shield active" id="request-survey-patient-popup" scss-load="vox-popup-request-survey">
