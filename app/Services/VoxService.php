        ...
        if(!empty($user)) {
            ...
            if(!empty($vox_id) && (!empty($vox) || !empty($admin) )) {
                ...
                if($for_app) {
                    ...
                    if($array['question']->is_control == -1 || (empty($array['question']->dont_randomize_answers) && empty($array['question']->vox_scale_id) && empty($array['scales'][$array['question']->vox_scale_id]))) {
