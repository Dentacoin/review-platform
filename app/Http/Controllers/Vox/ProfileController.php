...
class ProfileController extends FrontController
{
    ...
    public function home($locale=null) {
        ...
        if($this->user->is_dentist && $this->user->status!='approved' && $this->user->status!='added_approved' && $this->user->status!='admin_imported' && $this->user->status!='added_by_clinic_claimed' && $this->user->status!='admin_imported' && $this->user->status!='test') {
    ...
    public function privacy($locale=null) {
        ...
        if($this->user->is_dentist && $this->user->status!='approved' && $this->user->status!='added_approved' && $this->user->status!='admin_imported' && $this->user->status!='added_by_clinic_claimed' && $this->user->status!='test') {
            return redirect(getLangUrl('welcome-to-dentavox'));
        }
        if($this->user->isBanned('vox')) {
            return redirect(getLangUrl('profile/vox'));
