...
class NotFoundController extends FrontController
{
	...
	public function home($locale=null) {
		...
		$featured = User::where('is_dentist', 1)->whereIn('status', ['approved','added_approved','admin_imported','added_by_clinic_claimed','added_by_clinic_unclaimed','added_by_dentist_claimed','added_by_dentist_unclaimed'])->orderBy('avg_rating', 'DESC');
