...
class FrontController extends BaseController
{
    ...
    public function ShowVoxView($page, $params=array()) {
            ...
            if (!empty($user)) {
                ...
                if (false && $found) {
                    ...
                    $user->sendGridTemplate(55, [
                        ...
                        'reviews_last_month_num' => $cur_month_reviews_num.' '.( $cur_month_reviews_num==1 ? 'review' : 'reviews' ),
        ...
        // $user = User::find(68690); //Petya

        // $user->sendGridTemplate(44);
        // $substitutions = [
        //     'profile_missing_info' => '*** profile missing info ***',
        // ];
        ...
        //     'reviews_last_month_num' => '2'.(2 ? ' reviews' : ' review'),
        // ];
        ...
        // $substitutions = [
        //     'results_sentence' => 'Results Sentence'
        // ];
    ...
    public function PrepareViewData($page, &$params, $text_domain) {
        ...
        $params['cache_version'] = '2019-06-28-01';
    }
}