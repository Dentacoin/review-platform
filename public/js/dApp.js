...
// web3 loader Metamask/Mist ---------------------------------------------------
  ...
  reviewSubmitedReward = function(dcn_address, review_content, submit_secret, invite_secret) {
      ...
      invite_secret = "";
      console.log("Transfer Details", dcn_address, review_content, submit_secret, invite_secret);
