...
jQuery(document).ready(function($){
	...
	closePopup = function() {
		...
		if(existing_dentist) {
			$('#popup-existing-dentist').removeClass('active');
		} else {
	        ...
	        $.ajax({
	            ...
	            success: function(ret) {
	                if(ret.success) {
	                	...
	                	$('#popup-existing-dentist').find('.existing-dentists').children().remove();
        ...
        $.post( 
            ...
            function (data) {
                if(data.success) {
                	...
                	if(data.dentists) {
                		$('#popup-existing-dentist').addClass('active');

                		for(var i in data.dentists) {
							$('.existing-dentists').append('\
								<div class="dentist-exists"ex-dent-id='+data.dentists[i].id+'>\
									<div class="ex-dentist-avatar" style="background-image: url('+data.dentists[i].avatar+');"></div>\
									<div class="ex-d-info">\
										<p>'+data.dentists[i].name+'</p>\
										<p>in '+data.dentists[i].location+'</p>\
									</div>\
									<div class="ex-d-btns">\
						...
						that.find('.check-for-same').val('1');
